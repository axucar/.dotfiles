...
before packages are loaded."
 ...
 '(("TODO" . "#dc752f")
   ...
   ("FAIL" . "#8c5353")
   ("DONE" . "#afd8af")))
 (setq org-todo-keywords '((sequence "TODO" "NEXT" "PROG" "DONE" "|")))
)
